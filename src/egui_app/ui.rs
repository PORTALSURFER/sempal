...
pub struct EguiApp {
    ...
    edit_fade_mute_drag_start_in: Option<f32>,
    edit_fade_mute_drag_start_out: Option<f32>,
    edit_fade_mute_drag_start_pos_in: Option<f32>,
    edit_fade_mute_drag_start_pos_out: Option<f32>,
