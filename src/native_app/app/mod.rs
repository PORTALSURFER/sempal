...
pub(in crate::native_app) use state::{
    ...
    MetadataAppState, NativeAppState, OverflowFadeAnimations, PendingFolderDelete,
    ...
    StarmapViewportChange, StartupState, StatusState, UiAppState, UnsupportedFilesDialogState,
