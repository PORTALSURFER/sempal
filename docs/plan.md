...
5. [x] Offload and streamline IO/rendering: async wav list loads, background file existence checks, larger waveform cache/prefetch, and evaluate paging/virtualization for very large lists.
